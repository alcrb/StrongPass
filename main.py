'''
Random Password Generateur using Python
Auteur: Alex C
'''
...
# Creer un titre
label_title = Label(right_frame, text="Mot de passe", font=("Helvetica", 20), bg='#1E191A', fg='white')
label_title.pack()
...
# Creer un bouton
generate_password_button = Button(right_frame, text="Générer", font=("Helvetica", 20), bg='#1E191A', fg='white', command=generate_password)
